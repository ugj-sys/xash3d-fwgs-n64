...
// common with leaf
	...
	// float		minmaxs[6];	// ERADICATED: Conserves hundreds of KB on N64
...
// begin userdata
	...
	void		*surfcache[4];	// EXPLICIT CACHE SLOTS: Reclaims ~220KB over generic reserved block
} mextrasurf_t;
...
#define MAX_EFRAGS		512	// FORCED N64 CAP: Recovering another 120+ KB instantly flawlessly now
