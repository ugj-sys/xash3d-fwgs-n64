...
#if	!id386
#define BLEND_LM(pix, light) vid.colormap[(pix >> 3) | ((light & 0x1e00) << 4)] | ( pix & 7 );
...
void R_InitCaches (void)
{
	...
	{
#if XASH_N64
		size = SURFCACHE_SIZE_AT_320X240 / 3; // MODERATE BALANCE TO 256KB ENSURING TEXTURE STABILITY
#else
