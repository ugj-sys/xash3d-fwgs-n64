...
void SV_Init( void )
{
	...
	Con_Printf( "--- FINAL SERVER ANATOMY CHECK ---\n" );
	Con_Printf( "sizeof(server_t) = %d\n", (int)sizeof(server_t) );
	Con_Printf( "OFF time = %d\n", (int)offsetof(server_t, time) );
	Con_Printf( "OFF model_prec = %d\n", (int)offsetof(server_t, model_precache) );
	Con_Printf( "OFF models = %d\n", (int)offsetof(server_t, models) );
	Con_Printf( "OFF consistency = %d\n", (int)offsetof(server_t, consistency_list) );
	Con_Printf( "OFF resources = %d\n", (int)offsetof(server_t, resources) );
	Con_Printf( "OFF datagram = %d\n", (int)offsetof(server_t, datagram) );
	Con_Printf( "OFF signon = %d\n", (int)offsetof(server_t, signon) );
	Con_Printf( "--- END SERVER ANATOMY CHECK ---\n" );
