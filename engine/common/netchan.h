...
#define NET_MAX_PAYLOAD		8192	// FORCED N64: Liberates 168KB of redundant gameplay buffer space!
...
#define MULTIPLAYER_BACKUP		2	// MINIMAL N64 (Must be at least 2 to prevent oldframe aliasing in delta decompression!)
#define SINGLEPLAYER_BACKUP		2	// MINIMAL N64
#define CMD_BACKUP			64	// RESTORED: Allows client input to buffer safely during frame lags
#define CMD_MASK			(CMD_BACKUP - 1)
#define NUM_PACKET_ENTITIES		32	// MINIMAL N64
#define MAX_CUSTOM_BASELINES		64
#define NET_LEGACY_EXT_SPLIT		(1U<<1)
#define NETSPLIT_BACKUP 1 // MINIMAL N64
#define NETSPLIT_BACKUP_MASK (NETSPLIT_BACKUP - 1)
#define NETSPLIT_HEADER_SIZE 18
// END OF BUFFER CONTROLS (STRIPPED FOR N64)
