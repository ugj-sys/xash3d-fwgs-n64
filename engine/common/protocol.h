...
#define MAX_VISIBLE_PACKET_BITS	8	// RESTORED TO 8: 256 visible entities per packet recovers 85KB static memory.
...
#define MAX_CLIENT_BITS		0		// FORCED N64 SOLO: 1 Player (Reclaims 400+ KB of Static RAM instantly)
...
#define MAX_EVENT_BITS		5		// N64 MINIMAL: 32 Events
#define MAX_EVENTS			32	// FORCED MINIMUM
...
#else
#define MAX_MODELS			384		// CONSTRAINED EXPANSION: 384 allows 72+ submodels without OOMing the heap via static BSS allocation.
#endif

#define MAX_SOUND_BITS		11
#define MAX_SOUNDS			256	// FORCED MINIMUM
#define MAX_SOUNDS_NONSENTENCE MAX_SOUNDS

#define MAX_ENTITY_BITS		11		// UPLIFTED TO 2048: Fully satisfies modern HL levels without network truncations
...
#define MAX_CUSTOM_BITS		5		// N64 MINIMAL: 32 Files Max
#define MAX_CUSTOM			(1<<MAX_CUSTOM_BITS)// 5 bits == 32 generic file
...
#define MAX_RENDER_DECALS		256		// FORCED N64 CAP: Reclaims 220+ KB instantly flawlessly now
...
#define MAX_RESOURCES		256		// ABSOLUTE CAP: Instantly recovers hundreds of KB from static client_t
...
// ALL CONDITIONAL OVERRIDES REMOVED PERMANENTLY
// Quake1 Protocol
